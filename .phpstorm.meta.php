...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Project Triasmitra\HRIS 2.0\employee_new\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Project Triasmitra\\HRIS 2.0\\employee_new\\public\\storage','logging.default',
...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','flare.key',
...
'ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','generated::zTbMokXKB3lFI4VP','generated::TpdGjj2J1gbgPjwb',
'dashboard','login','generated::011McUqDuEeMaDgd','logout','divisi.index',
'divisi.create','divisi.store','divisi.edit','divisi.update','divisi.destroy',
'department.index','department.create','department.store','department.edit','department.update',
'department.destroy','master-jabatan.index','master-jabatan.create','master-jabatan.store','master-jabatan.edit',
'master-jabatan.update','master-jabatan.destroy','master-eselon.index','master-eselon.create','master-eselon.store',
'master-eselon.edit','master-eselon.update','master-eselon.destroy','lokasi-kerja.index','lokasi-kerja.create',
'lokasi-kerja.store','lokasi-kerja.edit','lokasi-kerja.update','lokasi-kerja.destroy','master-posisi.index',
'master-posisi.create','master-posisi.store','master-posisi.edit','master-posisi.update','master-posisi.destroy',
'reset.pass.user.index','reset.password','general.index','general.edit','general.destroy',
'general.update','approval.index','approval.edit','approval.update','hari-libur-nasional.index',
'hari-libur-nasional.create','hari-libur-nasional.store','hari-libur-nasional.edit','hari-libur-nasional.update','hari-libur-nasional.destroy',
'cuti-bersama.index','cuti-bersama.create','cuti-bersama.store','cuti-bersama.edit','cuti-bersama.update',
'cuti-bersama.destroy','pemotongan-cuti.index','pemotongan-cuti.create','pemotongan-cuti.store','pemotongan-cuti.edit',
'pemotongan-cuti.update','pemotongan-cuti.destroy','kuota-cuti.index','kuota-cuti.create','kuota-cuti.store',
'tracking-cuti.index','tracking-cuti-tahunan.detail','tracking-cuti-umum.detail','tracking-cuti-besar.detail','tracking-izin-personal.index',
'tracking-izin-personal.detail','tracking-spd.index','tracking-spd.print','tracking-spd.detail','tracking-medical.index',
'tracking-medical.print','tracking-medical.detail','employee.index','employee.detail','employee.create',
'employee.store','employee.update-photo','employee.approval-data','data-diri.update','kontak.update',
'kontak-darurat.update','keluarga.create','keluarga.update','keluarga.delete','pendidikan.create',
'pendidikan.update','pendidikan.delete','info-karyawan.update','user-account.update','user-account.delete',
'kontrak-karyawan.create','kontrak-karyawan.update','kontrak-karyawan.delete','penilaian-akhir.create','penilaian-akhir.update',
'penilaian-akhir.delete','pelatihan.create','pelatihan.update','pelatihan.delete','penghargaan.create',
'penghargaan.update','penghargaan.delete','surat-peringatan.create','surat-peringatan.update','surat-peringatan.delete',
'bahasa.create','bahasa.update','bahasa.delete','bank.create','bank.update',
'bank.delete','npwp.create','npwp.update','npwp.delete','pengalaman-kerja.create',
'pengalaman-kerja.update','pengalaman-kerja.delete','rekam-medis.update',);
        registerArgumentsSet('views', 
'auth.login','hrd.dashboard','hrd.employee.detail','hrd.employee.detail-dummy','hrd.employee.form',
'hrd.employee.form-dummy','hrd.employee.index','hrd.employee.pegawai_list','hrd.manageApplication.summary-manage-app','hrd.manageApplication.user-aas',
'hrd.manageApplication.user-ams','hrd.manageApplication.user-ims','hrd.masterSetup.department.form','hrd.masterSetup.department.index','hrd.masterSetup.divisi.form',
'hrd.masterSetup.divisi.index','hrd.masterSetup.hirarkiUser.approval.form','hrd.masterSetup.hirarkiUser.approval.index','hrd.masterSetup.hirarkiUser.general.form','hrd.masterSetup.hirarkiUser.general.index',
'hrd.masterSetup.masterEselon.form','hrd.masterSetup.masterEselon.index','hrd.masterSetup.masterJabatan.form','hrd.masterSetup.masterJabatan.index','hrd.masterSetup.masterLokasiKerja.form',
'hrd.masterSetup.masterLokasiKerja.index','hrd.masterSetup.masterPosisi.form','hrd.masterSetup.masterPosisi.index','hrd.masterSetup.resetPassUser.index','hrd.reports.report-cuti',
'hrd.reports.report-izin-personal','hrd.reports.report-medical','hrd.reports.report-spd','hrd.setupEvent.cutiBersama.form','hrd.setupEvent.cutiBersama.index',
'hrd.setupEvent.hariLiburNasional.form','hrd.setupEvent.hariLiburNasional.index','hrd.setupEvent.kuotaCuti.form','hrd.setupEvent.kuotaCuti.index','hrd.setupEvent.pemotonganCuti.form',
'hrd.setupEvent.pemotonganCuti.index','hrd.trackingDocument.cuti.detail-cuti-besar','hrd.trackingDocument.cuti.detail-cuti-tahunan','hrd.trackingDocument.cuti.detail-cuti-umum','hrd.trackingDocument.cuti.index-cuti',
'hrd.trackingDocument.izinPersonal.detail-izin-personal','hrd.trackingDocument.izinPersonal.index-izin-personal','hrd.trackingDocument.medical.detail-medical','hrd.trackingDocument.medical.index-medical','hrd.trackingDocument.medical.print-medical',
'hrd.trackingDocument.spd.detail-spd','hrd.trackingDocument.spd.index-spd','hrd.trackingDocument.spd.print-spd','karyawan.dashboard','layouts.auth',
'layouts.css','layouts.footer','layouts.header','layouts.master','layouts.script',
'layouts.sidebar','login','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
