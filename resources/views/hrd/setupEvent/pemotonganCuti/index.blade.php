        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Data Pemotongan Cuti</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="dt-ext table-responsive custom-scrollbar">
                        <table class="display table-striped border table-lg" id="export-button">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Deskripsi Pemotongan Cuti</th>
                                    <th>Lama Cuti</th>
                                    <th>Tanggal Mulai</th>
                            ...
                            <tbody>
                                @foreach ($pemotonganCuti as $data )
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $data->jenis_setup_cuti }}</td>
                                    ...
                                    {{-- <td>
                                        <a type="button" class="btn btn-success"
                                            href="{{ route('pemotongan-cuti.edit', $data->id_setup_cuti ) }}" title="edit">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </a>
                                        <a type="button" class="btn btn-danger btn-delete"
                                            data-url="{{ route('pemotongan-cuti.destroy', $data->id_setup_cuti ) }}"
                                            data-name="{{ $data->jenis_setup_cuti }}" title="hapus">
