        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Cuti Bersama</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="dt-ext table-responsive custom-scrollbar html-expert-table">
                        <table class="display table-striped border table-lg" id="export-button">
                            ...
                            <tbody>
                                @foreach ($cutiBersama as $data )
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $data->nama_cuti_bersama }}</td>
                                    <td>{{ $data->lama_cuti ?? '0'}} Hari</td>
                                    <td>{{ $data->tanggal_cuti_bersama_formatted  }}</td>
                                    <td>
                                        <a type="button" class="btn btn-success"
                                            href="{{ route('cuti-bersama.edit', $data->code) }}" title="edit">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </a>
                                        <a type="button" class="btn btn-danger btn-delete"
                                            data-url="{{ route('cuti-bersama.destroy', $data->code) }}"
                                            data-name="{{ $data->nama_cuti_bersama }}" title="hapus">
