            ...
            <div class="card">
                <div class="card-header pb-0 card-no-border">
                    <div class="header-top">
                        <h5>Data Hari Libur Nasional</h5>
                    </div>
                </div>
                <div class="card-header card-no-border text-start">
                    <div class="card-header-right-icon"><a class="btn btn-primary f-w-500"
                            href="{{ route('hari-libur-nasional.create') }}"><i class="fa-solid fa-plus pe-2"></i>Tambah Data</a></div>
                </div>
                <div class="card-body">
                    <div class="dt-ext table-responsive custom-scrollbar html-expert-table">
                        <table class="display table-striped border table-lg" id="export-button">
                            ...
                            <tbody>
                                @foreach ($hariLiburNasional as $data )
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $data->nama_libur }}</td>
                                    <td>{{ $data->tanggal_libur }}</td>
                                    <td>
                                        <a type="button" class="btn btn-success"
                                            href="{{ route('hari-libur-nasional.edit', $data->code) }}" title="edit">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </a>
                                        <a type="button" class="btn btn-danger btn-delete"
                                            data-url="{{ route('hari-libur-nasional.destroy', $data->code) }}"
                                            data-name="{{ $data->nama_libur }}" title="hapus">
