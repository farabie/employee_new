                    ...
                    <div class="card-body animated-form">
                        <form class="row g-3 needs-validation custom-input" novalidate="" method="post"
                            ...
                            <div class="col-12 position-relative">
                                <label class="form-label" for="nama_posisi"><span style="color: red">*
                                    </span>Nama Posisi</label>
                                <input name="nama_posisi" class="form-control required" id="nama_posisi"
                                    type="text" placeholder="Masukkan nama posisi" required=""
                                    value="{{ old('nama_posisi', $masterPosisi->nama_posisi) }}">
                                @error('nama_posisi')
