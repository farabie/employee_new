...
@section('title', 'Master Data Posisi')
                ...
                <div class="card-body">
                    <div class="dt-ext table-responsive custom-scrollbar html-expert-table">
                        <table class="display table-striped border table-lg" id="export-button">
                            ...
                            <tbody>
                                @foreach ($masterPosisi as $data )
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $data->nama_posisi }}</td>
                                    <td>
                                        <a type="button" class="btn btn-success"
                                            href="{{ route('master-posisi.edit', $data->id ) }}" title="edit">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </a>
                                        <a type="button" class="btn btn-danger btn-delete"
                                            data-url="{{ route('master-posisi.destroy', $data->id) }}"
