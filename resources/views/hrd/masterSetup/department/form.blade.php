                ...
                <div class="card-body animated-form">
                    <form class="row g-3 needs-validation custom-input" novalidate="" method="post"
                        ...
                        <div class="col-12 position-relative">
                            <label class="form-label" for="nama_department">Nama Departemen</label>
                            <input name="nama_department" class="form-control required" id="nama_department" type="text"
                                placeholder="Masukkan Nama Departement" required=""
