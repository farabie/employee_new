...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h3>Master Data Lokasi Kerja</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb">
            ...
            <div class="card">
                <div class="card-header pb-0 card-no-border">
                    <div class="header-top">
                        <h5>Data Master Data Lokasi Kerja</h5>
                    </div>
                </div>
                <div class="card-header card-no-border text-start">
                    <div class="card-header-right-icon"><a class="btn btn-primary f-w-500"
                            href="{{ route('lokasi-kerja.create') }}"><i class="fa-solid fa-plus pe-2"></i>Tambah Data</a></div>
                </div>
                <div class="card-body">
                    <div class="dt-ext table-responsive custom-scrollbar html-expert-table">
                        <table class="display table-striped border table-lg" id="export-button">
                            ...
                            <tbody>
                                @foreach ($lokasiKerja as $data )
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $data->nama_lok_kerja }}</td>
                                    <td>
                                        <a type="button" class="btn btn-success"
                                            href="{{ route('lokasi-kerja.edit', $data->id ) }}" title="edit">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </a>
                                        <a type="button" class="btn btn-danger btn-delete"
                                            data-url="{{ route('lokasi-kerja.destroy', $data->id ) }}"
                                            data-name="{{ $data->nama_lok_kerja }}" title="hapus">
