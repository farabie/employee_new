                    ...
                    <div class="card-body animated-form">
                        <form class="row g-3 needs-validation custom-input" novalidate="" method="post"
                            ...
                            <div class="col-12 position-relative">
                                <label class="form-label" for="nama_lok_kerja"><span style="color: red">*
                                    </span>Nama Lokasi Kerja</label>
                                <input name="nama_lok_kerja" class="form-control required" id="nama_lok_kerja"
                                    type="text" placeholder="Masukkan nama lokasi kerja" required=""
                                    value="{{ old('nama_lok_kerja', $lokasiKerja->nama_lok_kerja) }}">
                                @error('nama_lok_kerja')
