                    ...
                    <div class="card-body animated-form">
                        <form class="row g-3 needs-validation custom-input" novalidate="" method="post"
                            ...
                            <div class="col-12 position-relative">
                                <label class="form-label" for="nama_masteresl"><span style="color: red">*
                                    </span>Nama Grade</label>
                                <input name="nama_masteresl" class="form-control required" id="nama_masteresl"
                                    type="text" placeholder="Masukkan nama grade" required=""
                                    value="{{ old('nama_masteresl', $masterEselon->nama_masteresl) }}">
                                @error('nama_masteresl')
