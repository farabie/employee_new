                    ...
                    <div class="card-body animated-form">
                        <form class="row g-3 needs-validation custom-input" novalidate="" method="post"
                            ...
                            <div class="col-12 position-relative">
                                <label class="form-label" for="nama_masterjab"><span style="color: red">*
                                    </span>Nama Jabatan</label>
                                <input name="nama_masterjab" class="form-control required" id="nama_masterjab"
                                    type="text" placeholder="Masukkan nama jabatan" required=""
                                    value="{{ old('nama_masterjab', $masterJabatan->nama_masterjab) }}">
                                @error('nama_masterjab')
