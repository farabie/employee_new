...
@section('title', 'Detail Cuti Tahunan')
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Tracking Cuti Tahunan</li>
                        <li class="breadcrumb-item active">Detail Cuti Tahunan</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <div class="header-top">
                            <h3>Detail Tracking Cuti Tahunan ({{ $cutiTahunan->nama_pegawai }})</h3>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="timeline-container">
                                    @php
                                        ...
                                        $atasan1Status = $cutiTahunan->approve_atasan_1;
                                        $atasan2Status = $cutiTahunan->approve_atasan_2;
                                        $hrdStatus = $cutiTahunan->approve_atasan_3;
                                        // $dirStatus = $cutiTahunan->approve_direktur ?? 0;
                                    @endphp
                                        ...
                                        <li
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-text">
                                                    ...
                                                    <span class="timeline-title">{{ $cutiTahunan->nama_pegawai }}</span>
                                                    @if ($cutiTahunan->tgl_pengajuan)
                                                        <span
                                                            class="timeline-date">{{ \Carbon\Carbon::parse($cutiTahunan->tgl_pengajuan)->format('d M Y') }}</span>
                                                    @else
                                                        <span>-</span>
                                                    @endif
                                                </div>
                                        ...
                                        <li
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-text">
                                                    ...
                                                    <span class="timeline-title">{{ $cutiTahunan->nama_atasan1 }}</span>
                                                    @if ($cutiTahunan->date_approve_atasan_1)
                                                        <span
                                                            class="timeline-date">{{ \Carbon\Carbon::parse($cutiTahunan->date_approve_atasan_1)->format('d M Y') }}</span>
                                                    @else
                                                        <span>-</span>
                                                    @endif
                                                </div>
                                        ...
                                        <li
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-text">
                                                    ...
                                                    <span class="timeline-title">{{ $cutiTahunan->nama_atasan2 }}</span>
                                                    @if ($cutiTahunan->date_approve_atasan_2)
                                                        <span
                                                            class="timeline-date">{{ \Carbon\Carbon::parse($cutiTahunan->date_approve_atasan_2)->format('d M Y') }}</span>
                                                    @else
                                                        <span>-</span>
                                                    @endif
                                                </div>
                                        ...
                                        <li
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-text">
                                                    ...
                                                    @if ($cutiTahunan->date_approve_hrd)
                                                        <span
                                                            class="timeline-date">{{ \Carbon\Carbon::parse($cutiTahunan->date_approve_hrd)->format('d M Y') }}</span>
                                                    @else
                                                        <span>-</span>
                                                    @endif
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="nama" class="form-control" id="nama" type="text"
                                            value="{{ old('nama', $cutiTahunan->nama_pegawai) }}">
                                    </div>
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="tgl_pengajuan" class="form-control" id="tgl_pengajuan"
                                            type="text"
                                            value="{{ old('tgl_pengajuan', $cutiTahunan->tgl_pengajuan) }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="tgl_mulai" class="form-control" id="tgl_mulai"
                                            type="text" value="{{ old('tgl_mulai', $cutiTahunan->tgl_mulai) }}">
                                    </div>
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="tgl_selesai" class="form-control" id="tgl_selesai"
                                            type="text" value="{{ old('tgl_selesai', $cutiTahunan->tgl_selesai) }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="lama_cuti" class="form-control" id="lama_cuti"
                                            type="text" value="{{ old('lama_cuti', $cutiTahunan->lama_cuti) }} Hari">
                                    </div>
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="pengganti_cuti" class="form-control" id="pengganti_cuti"
                                            type="text"
                                            value="{{ old('pengganti_cuti', $cutiTahunan->nama_pengganti) }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="atasan1" class="form-control" id="atasan1"
                                            type="text" value="{{ old('atasan1', $cutiTahunan->nama_atasan1) }} Hari">
                                    </div>
                                    <div class="col-6 position-relative mb-3">
                                        <label class="form-label" for="atasan2">Atasan 2</label>
                                        <input disabled name="atasan2" class="form-control" id="atasan2"
                                            type="text" value="{{ old('atasan2', $cutiTahunan->nama_atasan2) }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="keterangan" class="form-control" id="keterangan"
                                            type="text" value="{{ old('keterangan', $cutiTahunan->keterangan) }}">
                                    </div>
                                    @if (!empty($cutiTahunan->keterangan_reject))
                                        <div class="col-6 position-relative mb-3">
                                            ...
                                            <input disabled name="keterangan_reject" class="form-control"
                                                ...
                                                value="{{ old('keterangan_reject', $cutiTahunan->keterangan_reject) }}">
                                        </div>
                                    @endif
                                </div>
                            </div>
