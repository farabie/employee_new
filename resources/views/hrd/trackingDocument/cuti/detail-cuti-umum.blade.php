...
@section('title', 'Detail Cuti Umum')
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Tracking Cuti Umum</li>
                        <li class="breadcrumb-item active">Detail Cuti Umum</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <div class="header-top">
                            <h3>Detail Tracking Cuti Umum ({{ $cutiUmum->nama_pegawai }})</h3>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="panel-body">
                                <div class="timeline-container">
                                    @php
                                        ...
                                        $atasan1Status = $cutiUmum->approve_atasan_1;
                                        $atasan2Status = $cutiUmum->approve_atasan_2;
                                        $hrdStatus = $cutiUmum->approve_atasan_3;
                                        // $dirStatus = $cutiUmum->approve_direktur ?? 0;
                                    @endphp
                                        ...
                                        <li
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-text">
                                                    ...
                                                    <span class="timeline-title">{{ $cutiUmum->nama_pegawai }}</span>
                                                    @if ($cutiUmum->tgl_pengajuan)
                                                        <span
                                                            class="timeline-date">{{ \Carbon\Carbon::parse($cutiUmum->tgl_pengajuan)->format('d M Y') }}</span>
                                                    @else
                                                        <span>-</span>
                                                    @endif
                                                </div>
                                        ...
                                        <li
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-text">
                                                    ...
                                                    <span class="timeline-title">{{ $cutiUmum->nama_atasan1 }}</span>
                                                    @if ($cutiUmum->date_approve_atasan_1)
                                                        <span
                                                            class="timeline-date">{{ \Carbon\Carbon::parse($cutiUmum->date_approve_atasan_1)->format('d M Y') }}</span>
                                                    @else
                                                        <span>-</span>
                                                    @endif
                                                </div>
                                        ...
                                        <li
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-text">
                                                    ...
                                                    <span class="timeline-title">{{ $cutiUmum->nama_atasan2 }}</span>
                                                    @if ($cutiUmum->date_approve_atasan_2)
                                                        <span
                                                            class="timeline-date">{{ \Carbon\Carbon::parse($cutiUmum->date_approve_atasan_2)->format('d M Y') }}</span>
                                                    @else
                                                        <span>-</span>
                                                    @endif
                                                </div>
                                        ...
                                        <li
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <div class="timeline-text">
                                                    ...
                                                    @if ($cutiUmum->date_approve_hrd)
                                                        <span
                                                            class="timeline-date">{{ \Carbon\Carbon::parse($cutiUmum->date_approve_hrd)->format('d M Y') }}</span>
                                                    @else
                                                        <span>-</span>
                                                    @endif
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="nama" class="form-control" id="nama" type="text"
                                            value="{{ old('nama', $cutiUmum->nama_pegawai) }}">
                                    </div>
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="tgl_pengajuan" class="form-control" id="tgl_pengajuan"
                                            type="text" value="{{ old('tgl_pengajuan', $cutiUmum->tgl_pengajuan) }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="tgl_mulai" class="form-control" id="tgl_mulai"
                                            type="text" value="{{ old('tgl_mulai', $cutiUmum->tgl_mulai) }}">
                                    </div>
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="tgl_selesai" class="form-control" id="tgl_selesai"
                                            type="text" value="{{ old('tgl_selesai', $cutiUmum->tgl_selesai) }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="lama_cuti" class="form-control" id="lama_cuti"
                                            type="text" value="{{ old('lama_cuti', $cutiUmum->lama_cuti) }} Hari">
                                    </div>
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="pengganti_cuti" class="form-control" id="pengganti_cuti"
                                            type="text"
                                            value="{{ old('pengganti_cuti', $cutiUmum->nama_pengganti) }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                ...
                                <div class="row">
                                    <div class="col-6 position-relative mb-3">
                                        ...
                                        <input disabled name="keterangan" class="form-control" id="keterangan"
                                            type="text" value="{{ old('keterangan', $cutiUmum->keterangan) }}">
                                    </div>
                                    @if (!empty($cutiUmum->keterangan_reject))
                                        <div class="col-6 position-relative mb-3">
                                            ...
                                            <input disabled name="keterangan_reject" class="form-control"
                                                ...
                                                value="{{ old('keterangan_reject', $cutiUmum->keterangan_reject) }}">
                                        </div>
                                    @endif
                                </div>
                            </div>
