    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                        src="{{ asset('assets/images/logo/icon_trias.png') }}" alt=""><img
                        class="img-fluid for-dark" src="{{ asset('assets/images/logo/icon_trias.png') }}"
                        alt=""></a></div>
            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="d-flex profile-media"><img class="b-r-10"
                        ...
                        <div class="flex-grow-1"><span>{{ Auth::user()->nama_user }}</span>
                            <p class="mb-0">{{ Auth::user()->hak_akses }} <i class="middle fa-solid fa-angle-down"></i></p>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div">
                        <li>
                            <!-- Ganti dari link biasa ke form POST -->
