        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Karyawan Dashboard</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-hr-6 col-sm-6">
                    <div class="card widget-11 widget-hover">
                        <div class="card-body">
                            <div class="common-align justify-content-start">
                                <div class="analytics-tread bg-light-warning">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="project-left-content">
                                            ...
                                            <p class="c-o-light">10 projects have been finished this year. </p>
                                            <div class="growth-info">
                                                ...
                                                <p class="f-w-500 c-light">Last Year <span
                                                        ...
                                                        class="badge badge-light-success">+14%</span></p>
                                            </div>
                                    ...
                                    <div class="col-sm-6"><img class="project-right-content img-fluid"
                                            src="../assets/images/dashboard-11/vector-pc.png" alt="vector pc"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card sales-report">
                            ...
                            <div class="header-top">
                                ...
                                <div class="card-header-right-icon">
                                    <div class="dropdown icon-dropdown">
                                        <button class="btn dropdown-toggle" id="applicationOverview" type="button"
                        ...
                        <div class="card-body pt-0 analytics-data application-overview">
                            <ul class="balance-data">
                                ...
                                <li><span class="circle bg-warning"> </span><span class="c-light ms-1">Hired</span></li>
                            </ul>
                    ...
                    <div class="card heading-space">
                        <div class="card-header card-no-border">
                            <div class="header-top">
                                ...
                                <div class="card-header-right-icon">
                                    <div class="dropdown icon-dropdown">
                                        <button class="btn dropdown-toggle" id="employeeList" type="button"
                                            data-bs-toggle="dropdown" aria-expanded="false"><i
                                                class="icon-more-alt"></i></button>
                                    ...
                                    <tbody>
                                        <tr class="inbox-data">
                                            ...
                                            <td>
                                                <div class="common-flex align-items-center"><img
                                                        ...
                                                        src="../assets/images/dashboard-11/user/12.jpg" alt="user"><a
                                                        class="f-w-500" href="user-list.html">Wade Warren</a></div>
                                            </td>
                                            <td>#45812</td>
                                            ...
                                            <td>
                                                <div class="common-align gap-2 justify-content-start">
                                                    <div class="square-white">
                                                        <svg>
                                                            <use href="../assets/svg/icon-sprite.svg#hr-pen"></use>
                                                        </svg>
                                                    </div>
                                                    <div class="square-white trash-3">
                                                        <svg>
                                                            <use href="../assets/svg/icon-sprite.svg#hr-trash"> </use>
                                                        </svg>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="inbox-data">
                                            ...
                                            <td>
                                                <div class="common-flex align-items-center"><img
                                                        ...
                                                        class="f-w-500" href="user-list.html">Michael Mit</a></div>
                                            </td>
                                            <td>#58698</td>
                                        ...
                                        <tr class="inbox-data">
                                            ...
                                            <td>
                                                <div class="common-flex align-items-center"><img
                                                        class="img-fluid rounded-circle"
                                                        src="../assets/images/dashboard-11/user/8.jpg" alt="user"><a
                                                        class="f-w-500" href="user-list.html">Jenny Wilson</a></div>
                                            </td>
                                            <td>#320148</td>
                                        ...
                                        <tr class="inbox-data">
                                            ...
                                            <td>
                                                <div class="common-flex align-items-center"><img
                                                        class="img-fluid rounded-circle"
                                                        src="../assets/images/dashboard-11/user/3.jpg" alt="user"><a
                                                        class="f-w-500" href="user-list.html">Guy Hawkins</a></div>
                                            </td>
                                            <td>#874264</td>
                                        ...
                                        <tr class="inbox-data">
                                            ...
                                            <td>
                                                <div class="common-flex align-items-center"><img
                                                        class="img-fluid rounded-circle"
                                                        src="../assets/images/dashboard-9/user/2.png" alt="user"><a
                                                        class="f-w-500" href="user-list.html">Esther Howard</a></div>
                                            </td>
                                            <td>#200148</td>
                                        ...
                                        <tr class="inbox-data">
                                            ...
                                            <td>
                                                <div class="common-flex align-items-center"><img
                                                        class="img-fluid rounded-circle"
                                                        src="../assets/images/dashboard-9/user/5.png" alt="user"><a
                                                        class="f-w-500" href="user-list.html">Jacob Jones</a></div>
                                            </td>
                                            <td>#985367</td>
                                        ...
                                        <tr class="inbox-data">
                                            ...
                                            <td>
                                                <div class="common-flex align-items-center"><img
                                                        class="img-fluid rounded-circle"
                                                        src="../assets/images/dashboard-9/user/3.png" alt="user"><a
                                                        class="f-w-500" href="user-list.html">Arlene McCoy</a></div>
                                            </td>
                                            <td>#45812</td>
                                        ...
                                        <tr class="inbox-data">
                                            ...
                                            <td>
                                                <div class="common-flex align-items-center"><img
                                                        class="img-fluid rounded-circle"
                                                        src="../assets/images/dashboard-9/user/1.png" alt="user"><a
                                                        class="f-w-500" href="user-list.html">Robert Fox</a></div>
                                            </td>
                                            <td>#589654</td>
                        ...
                        <div class="card-body px-0 pt-0">
                            <div class="recent-table table-responsive custom-scrollbar attendance-table">
                                <table class="table" id="attendance-overview">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a class="f-w-500" href="user-list.html">David Jones</a></td>
                                            <td>Web Designer</td>
                                            <td>9:26 AM</td>
                                            <td> <span class="badge badge-light-success">On Time</span></td>
                                        </tr>
                                        <tr>
                                            <td><a class="f-w-500" href="user-list.html">Joseph Miller</a></td>
                                            <td>UI-UX Designer</td>
                                            <td>10:48 AM</td>
                                            <td> <span class="badge badge-light-danger">Late</span></td>
                                        </tr>
                                        <tr>
                                            <td><a class="f-w-500" href="user-list.html">Daniel Moore</a></td>
                                            <td>Python Developer</td>
                                            <td>9:30 AM</td>
                                            <td> <span class="badge badge-light-success">On Time</span></td>
                                        </tr>
                                        <tr>
                                            <td><a class="f-w-500" href="user-list.html">Ava Garcia</a></td>
                                            <td>JS Developer</td>
                                            <td>10:04 AM</td>
                                            <td> <span class="badge badge-light-success">On Time </span></td>
                                        </tr>
                                        <tr>
                                            <td><a class="f-w-500" href="user-list.html">Amelia Lee</a></td>
                                            <td>Next Developer</td>
                                            <td>11:48 AM</td>
                                            <td> <span class="badge badge-light-danger">Late</span></td>
                                        </tr>
                                        <tr>
                                            <td><a class="f-w-500" href="user-list.html">Harper Scott</a></td>
                                            <td>Marketing</td>
                                            <td>04:45 AM</td>
                                            <td> <span class="badge badge-light-success">On Time</span></td>
                                        </tr>
                                        <tr>
                                            <td><a class="f-w-500" href="user-list.html">Jack Smith</a></td>
                                            <td>ML Developer</td>
                                            <td>02:20 AM</td>
                                            <td> <span class="badge badge-light-danger">Late</span></td>
                                        </tr>
                                        <tr>
                                            <td><a class="f-w-500" href="user-list.html">Cole Brown</a></td>
                                            <td>AI Developer</td>
                                            <td>03.45 AM</td>
                                            <td> <span class="badge badge-light-success">On Time</span></td>
                                        </tr>
                                ...
                                <div class="swiper swiper-11">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="birthday-usercard">
                                                <div class="btd-user"><img class="img-fluid"
                                                        src="../assets/images/dashboard-12/user/10.png"
                                                        alt="Birthday user">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="birthday-usercard">
                                                <div class="btd-user"><img class="img-fluid"
                                                        src="../assets/images/dashboard-12/user/2.png"
                                                        alt="Birthday user">
                                                    <div class="verified-user"><i class="fa-solid fa-check"></i></div>
                                                </div>
                                                <h5>Liam Taylor</h5>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="birthday-usercard">
                                                <div class="btd-user"><img class="img-fluid"
                                                        src="../assets/images/dashboard-12/user/5.png"
                                                        alt="Birthday user">
                                                    <div class="verified-user"><i class="fa-solid fa-check"></i></div>
                                                </div>
                    ...
                    <div class="card sales-report project-analytics">
                        <div class="card-header card-no-border">
                            <div class="header-top">
                                ...
                                <div class="card-header-right-icon">
                                    <div class="dropdown icon-dropdown">
                                        <button class="btn dropdown-toggle" id="projectAnalytics" type="button"
                                            data-bs-toggle="dropdown" aria-expanded="false"><i
                                                class="icon-more-alt"></i></button>
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="projectAnalytics">
                    ...
                    <div class="card schedule-calender">
                        <div class="card-header card-no-border">
                            <div class="header-top">
                                ...
                                <div class="card-header-right-icon"><a class="btn f-w-500" href="#!">+ Add</a></div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <ul class="schedule-wrapper nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item"><a class="nav-link" id="frd-tab" data-bs-toggle="tab" href="#frd"
                                        role="tab" aria-controls="frd" aria-selected="true">
                                        <h6>Fri </h6><span class="f-w-400">05</span>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link font-primary" id="sat-tab" data-bs-toggle="tab"
                                        href="#sat" role="tab" aria-controls="sat" aria-selected="false">
                                        <h6>Sat</h6><span class="f-w-400">06</span>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link font-primary" id="sun-tab" data-bs-toggle="tab"
                                        href="#sun" role="tab" aria-controls="sun" aria-selected="false">
                                    ...
                                    <ul class="activity-update">
                                        <li>
                                            <div class="d-flex align-items-center b-l-primary">
                                                <div class="left-schedule"><span>Meeting With Candidate</span>
                                                    <div class="common-f-start">
                                                        <div class="customers">
                                                            <ul>
                                                                ...
                                                                <li class="d-inline-block"><img
                                                                        class="img-40 rounded-circle"
                                                                        src="../assets/images/user/3.png" alt="user">
                                                                </li>
                                                                <li class="d-inline-block"><img
                                                                        class="img-40 rounded-circle"
                                                        ...
                                                        </div><span class="c-o-light schedule-name">Zoom Meeting</span>
                                                    </div>
                                                </div>
                                                <div class="right-schedule">
                                                    <svg class="fill-icon fill-success">
                                                        <use href="../assets/svg/icon-sprite.svg#clock"></use>
                                                    </svg><span class="c-o-light">09.00 - 12.00 AM</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center b-l-secondary">
                                                <div class="left-schedule"><span>Client Meeting with BDE</span>
                                                    <div class="common-f-start">
                                                        <div class="customers">
                                                            <ul>
                                                                <li class="d-inline-block"><img
                                                        ...
                                                        </div><span class="c-o-light schedule-name">HR Office</span>
                                                    </div>
                                                </div>
                                                <div class="right-schedule">
                                                    <svg class="fill-icon fill-success">
                                                        <use href="../assets/svg/icon-sprite.svg#clock"></use>
                                                    </svg><span class="c-o-light">01.00 - 02.00 AM</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center b-l-warning">
                                                <div class="left-schedule"><span>Interview With Candidate</span>
                                                    <div class="common-f-start">
                                                        <div class="customers">
                                                            <ul>
                                                                <li class="d-inline-block"><img
                                                ...
                                                <div class="right-schedule">
                                                    <svg class="fill-icon fill-success">
                                                        <use href="../assets/svg/icon-sprite.svg#clock"></use>
                                                    </svg><span class="c-o-light">02.00 - 02.30 AM</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center b-l-success">
                                                <div class="left-schedule"><span>Employee Engagement</span>
                                                    <div class="common-f-start">
                                                        <div class="customers">
                                                            <ul>
                                                                <li class="d-inline-block"><img
                                                ...
                                                <div class="right-schedule">
                                                    <svg class="fill-icon fill-success">
                                                        <use href="../assets/svg/icon-sprite.svg#clock"></use>
                                                    </svg><span class="c-o-light">03.00 - 04.15 AM</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center b-l-primary">
                                                <div class="left-schedule"><span>Training Session</span>
                                                    <div class="common-f-start">
                                                        ...
                                                        </div><span class="c-o-light schedule-name">Training Room</span>
                                                    </div>
                                                </div>
                                                <div class="right-schedule">
                                                    <svg class="fill-icon fill-success">
                                                        <use href="../assets/svg/icon-sprite.svg#clock"></use>
                                                    </svg><span class="c-o-light">05.30 - 06.00 AM</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex align-items-center b-l-info">
                                                <div class="left-schedule"><span>Performance Review</span>
                                                    <div class="common-f-start">
                                                        <div class="customers">
                                                            <ul>
                                                                <li class="d-inline-block"><img
                                                ...
                                                <div class="right-schedule">
                                                    <svg class="fill-icon fill-success">
                                                        <use href="../assets/svg/icon-sprite.svg#clock"></use>
                                                    </svg><span class="c-o-light">08.30 - 09:00 PM</span>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <div class="card">
                        <div class="card-header card-no-border">
                            <div class="header-top">
                                ...
                                <div class="card-header-right-icon">
                                    <div class="dropdown icon-dropdown">
                                        <button class="btn dropdown-toggle" id="interviewSchedule" type="button"
                                            data-bs-toggle="dropdown" aria-expanded="false"><i
                                                class="icon-more-alt"></i></button>
                                        <div class="dropdown-menu dropdown-menu-end"
                        ...
                        <div class="card-body interviewer-users pt-0">
                            <ul>
                                ...
                                <li>
                                    <div class="common-flex"> <img class="img-fluid"
                                            src="../assets/images/dashboard-11/user/2.jpg" alt="user">
                                        <div>
                                ...
                                <li>
                                    <div class="common-flex"> <img class="img-fluid"
                                            src="../assets/images/dashboard-11/user/7.jpg" alt="user">
                                        <div>
                                ...
                                <li>
                                    <div class="common-flex"> <img class="img-fluid"
                                            src="../assets/images/dashboard-11/user/10.jpg" alt="user">
                                        <div>
                                ...
                                <table class="table" id="leave-employee">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                        src="../assets/images/dashboard/user/6.jpg" alt="user">
                                                    <div class="img-content-box"><a class="f-w-500" href="#!">Alison
                                                            Carol</a>
                                                        <p class="mb-0 f-light">24 Jul to 26 Jul 2024</p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="common-align gap-2 justify-content-start">
                                                    ...
                                                    <div class="approval-box border border-danger"><i
                                                            class="fa-solid fa-ban txt-danger"></i></div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    <div class="img-content-box"><a class="f-w-500" href="#!">Miranda
                                                            Bailey</a>
                                                        <p class="mb-0 f-light">10 May to 12 May 2024</p>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    <div class="img-content-box"><a class="f-w-500" href="#!">Kathryn
                                                            Roe</a>
                                                        <p class="mb-0 f-light">01 Oct to 10 Oct 2024</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Sick Leave</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    <div class="img-content-box"><a class="f-w-500" href="#!">Andrew
                                                            Baker</a>
                                                        <p class="mb-0 f-light">15 Nov to 20 Nov 2024</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Personal Leave</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                        src="../assets/images/dashboard-11/user/9.jpg" alt="user">
                                                    <div class="img-content-box"><a class="f-w-500" href="#!">Bob
                                                            James</a>
                                                        <p class="mb-0 f-light">14 Feb to 16 Feb 2024</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Sick Leave</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                        src="../assets/images/dashboard-11/user/12.jpg" alt="user">
                                                    <div class="img-content-box"><a class="f-w-500" href="#!">Thomas
                                                            Tim</a>
                                                        <p class="mb-0 f-light">03 Mar to 10 Mar 2024</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Out of Town</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                        src="../assets/images/dashboard-11/user/5.jpg" alt="user">
                                                    <div class="img-content-box"><a class="f-w-500" href="#!">Muriel
                                                            Bing</a>
                                                        <p class="mb-0 f-light">09 Feb to 16 Feb 2024</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Out of Town</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                        src="../assets/images/dashboard-11/user/11.jpg" alt="user">
                                                    <div class="img-content-box"><a class="f-w-500" href="#!">Russell
                                                            Rose</a>
                                                        <p class="mb-0 f-light">01 Nov to 05 Nov 2024</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>Sick Leave</td>
