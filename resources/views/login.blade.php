    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7"><img class="bg-img-cover bg-center"
                    src="{{ asset('storage/assets/img/illustration_login1.png') }}" alt="looginpage"></div>
                        ...
                        <div class="login-main">
                            <form method="POST" action="{{ route('login') }}" class="theme-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="nik" name="nik" required=""
                                ...
                                <div class="form-group mb-0">
                                    <div class="form-check">
                                        <input id="remember_me" class="checkbox-primary form-check-input" id="checkbox1"
